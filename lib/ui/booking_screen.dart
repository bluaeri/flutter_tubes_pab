...
import 'package:sm_private_concert_ticket/widget/videoclipper.dart';
import 'package:sm_private_concert_ticket/widget/videoclipper2.dart';
import 'package:video_player/video_player.dart';

class BookingScreen extends StatefulWidget {
  final VideoPlayerController groupPlayerController;
  final VideoPlayerController reflectionPlayerController;
  final String groupName;

  BookingScreen(
      {this.groupPlayerController,
...
class _BookingScreenState extends State<BookingScreen>
  ...
  void initState() {
    super.initState();
    widget.groupPlayerController.setLooping(true);
    widget.reflectionPlayerController.setLooping(true);
    widget.groupPlayerController.play();
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    Center(
                      child: widget.groupPlayerController.value.isInitialized
                          ? AnimatedBuilder(
                              ...
                              child: VideoPlayer(widget.groupPlayerController),
                            )
                          : Container(),
                    ),
                  ],
